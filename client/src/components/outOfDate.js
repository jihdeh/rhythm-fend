      ...
      <div className="container">
        <div className="row">
          <div className="columns small-12">
            ...
            <h3>NEW UPDATES for Voters!!!!</h3>
            <b>
              We have created a lite version for voting for your contestants on
              Sound IT Africa. We are trying our best to make sure votings are
              secure and seamless
            </b>
            <h4>
              Please visit{' '}
              <a className="upgrade_link" href="https://vote.soundit.africa">
                https://vote.soundit.africa
              </a>, search for your contestant, and hit the vote button.
            </h4>
            <h5>
              For now we don't have full support for (opera mini, uc browsers
              and really low versioned mobile browsers)
            </h5>
          </div>
        </div>
      </div>
