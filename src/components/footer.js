          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-1 col-md-1 col-lg-offset-1 footer__navs_logo_container">
                <img
                  src="https://www.reech.com/images/footer/logo-reech.png"
                  alt="Logo Reech"
                />
              </div>
                ...
                <nav>
                  <ul>
                    <li className="footer__navs_link">
                      <a href="mailto:contact@reech.com">contact@reech.com</a>
                    </li>
                  </ul>
                </nav>
              </div>
                ...
                <nav>
                  <ul>
                    <li className="footer__navs_link">
                      ...
                      <a href="https://www.instagram.com/reech_com/">
                        Instagram
                      </a>
                    </li>
                    <li className="footer__navs_link">
                      <div className="footer__navs_link_social_icon footer__navs_link_social_icon-facebook" />
                      <a href="https://www.facebook.com/reechcom">Facebook</a>
                    </li>
                    <li className="footer__navs_link">
                    ...
                    <li className="footer__navs_link">
                      ...
                      <a href="https://twitter.com/Reech_com">Twitter</a>
                    </li>
                    <li className="footer__navs_link">
                      <div className="footer__navs_link_social_icon footer__navs_link_social_icon-youtube" />
                      <a href="https://www.youtube.com/channel/UCdH64hnE10S9bHw55qk39Pg">
                        YouTube
                      </a>
                    </li>
                  </ul>
            ...
            <div className="container-fluid">
              <div className="row">
                <div className="col-lg-12 col-md-12">
                  <p>
                    <span>
                      Reech France � SAS (simplified joint stock company) with
                      share capital of �304,453.38
                    </span>
                    <span className="footer__address_line_separator">|</span>
                    <span>82 rue d'Hauteville 75010 Paris</span>
                    <span className="footer__address_line_separator">|</span>
                    <span>+33 (0)1 84 20 24 89</span>
                    <span className="footer__address_line_separator">|</span>
                    <a href="mailto:contact@reech.com">contact@reech.com</a>
                  </p>
                </div>
